...
namespace UIv2
{
    public partial class Form1 : Form
    {
        ...
        private void textBox1_TextChanged(object sender, EventArgs e)
        {
            ...
            badW = textBox1.Text;//" | " + textBox1.Text; 
          //  badW = w00[0].ToString(); 
            //Console.Write("@@@@ " + badW); 

            /*
            while (list[wordUp] != null)
            {

                wordUp++;
            }

            string[] lines = { "#JSGF V1.0;", "grammar hello;", "public <greet> = (Good morning | basically | umm | test | ahh | );" };

            System.IO.File.WriteAllLines(@"C:\Users\tlewis\Desktop\demo\sphinx\helloworld\hello.gram", lines);
             */
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            if (wordList[0] != null)
            {
                string[] lines = { "#JSGF V1.0;", "grammar hello;", "public <greet> = (Good morning | basically | umm | ahh | " + string.Join(" | ", wordList.ToArray()) + ");"};
               // Console.Write("#JSGF V1.0;" + "grammar hello;" + "public <greet> = (Good morning | basically | umm | test | ahh | " + string.Join(" | ", wordList.ToArray()) + ");");
                System.IO.File.WriteAllLines(@"C:\Users\tlewis\Desktop\demo\sphinx\helloworld\hello.gram", lines);
            }
            else
            {
                string[] lines00 = { "#JSGF V1.0;", "grammar hello;", "public <greet> = (basically | umm | ahh );" };                
                System.IO.File.WriteAllLines(@"C:\Users\tlewis\Desktop\demo\sphinx\helloworld\hello.gram", lines00);
            }
           ...
           /* while (true)
            ...
            clientProcess.StartInfo.Arguments = @"-jar " + @"C:\Users\tlewis\Desktop\sdet.jar";
            clientProcess.Start();
          //Thread.Sleep(5000);
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            using (var streamReader00 = new StreamReader(fileStream01, Encoding.UTF8))
            {
                string postureLine;
                while ((postureLine = streamReader00.ReadLine()) != null)
                {
            ...
            using (var streamReader = new StreamReader(fileStream02, Encoding.UTF8))
            {
                string rhythmLine;
            ...
            {
                listBox6.Items.Add("You leaned or slouched" + (Int32.Parse(posture[0]) + Int32.Parse(posture[1]) + " times"));
                listBox6.Items.Add("You leaned to your left");
                listBox6.Items.Add(posture[0] + " times");
                listBox6.Items.Add("You leaned to your right");
                listBox6.Items.Add(posture[1] + " times");
                if ((Int32.Parse(posture[0]) + Int32.Parse(posture[1])) <= 5)
                {
                    listBox6.Items.Add("Overall you did pretty well");
                    listBox6.Items.Add("Just be more conscience ");
                    listBox6.Items.Add("to stand up straight");
                }
                else if ((Int32.Parse(posture[0]) + Int32.Parse(posture[1])) > 5)
                {
                    listBox6.Items.Add("This could use improvement. We suggest");
                    listBox6.Items.Add("you try keeping you feet planted firmly");
                    listBox6.Items.Add("and standing up straight");
                }
            }
            else
            {
